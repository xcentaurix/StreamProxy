...
class StreamProxyServiceMonitor:
        ...
        try:
            ...
            if self._is_already_proxy_url(clean_url):
                ...
                if original_url:
                    ...
                    enhanced_log(f"🎬 [SERVICEMONITOR] Creato riferimento m3u8 per gestione HLS", "INFO")
            ...
            if any(vix_domain in url_lower for vix_domain in ['vix', 'vixcloud', 'vixsrc']):
                ...
                enhanced_log(f"🧹 [SERVICEMONITOR] Pulizia cache per cambio canale VIX", "INFO")
                try:
                ...
                if FREESHOT_AVAILABLE and is_freeshot_link(clean_url):
                    ...
                    try:
                        ...
                        if resolved_freeshot and resolved_freeshot.get('resolved_url'):
                            ...
                            enhanced_log(f"✅ [SERVICEMONITOR] URL Freeshot proxy creato (supporto fMP4)", "INFO")
            ...
            try:
                ...
                if TVTAP_WMS_AVAILABLE and is_wms_tvtap_url(clean_url):
                    ...
                    if tvtap_proxy_url:
                        enhanced_log(f"✅ [SERVICEMONITOR] URL TVTap WMS risolto", "INFO")
                ...
                # Gestione TVTap standard
                    ...
                    enhanced_log(f"✅ [SERVICEMONITOR] URL TVTap configurato", "INFO")
            except Exception as e:
    ...
    def _should_proxy(self, url: str) -> bool:
        ...
        enhanced_log(f"🔄 [SERVICEMONITOR] URL non autorizzato, passthrough diretto", "DEBUG")
        return False
    ...
    def _force_exteplayer3_for_mpd(self, ref, mpd_url):
        ...
        try:
            ...
            if len(parts) > 0:
                ...
                enhanced_log(f"✅ [SERVICEMONITOR] Riferimento modificato per exteplayer3 (5001)", "INFO")
